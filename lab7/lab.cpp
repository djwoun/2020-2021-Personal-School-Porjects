    ...
    do
    {
        ...
        if (command == "load") {
            if (mips == nullptr) {
                ...
                // function returns address, mips's address is set that returned address
        ...
        else if (command == "reg")
        {
            ...
            else
            {
                ...
                // if it succeeds, the integer is matched with a register name
